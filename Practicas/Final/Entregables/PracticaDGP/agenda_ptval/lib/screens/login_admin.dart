import 'package:agenda_ptval/models/admin.dart';
...
class LoginAdminScreen extends StatefulWidget {
  ...
  LoginAdminScreen({required this.rol, Key? key}) : super(key: key);
...
class _LoginAdminScreenState extends State<LoginAdminScreen> {
  ...
  signIn() {
    ...
    controlador.getAdmin(user).then((value) {
