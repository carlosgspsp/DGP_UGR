...
class CrearTareasScreen extends StatefulWidget {
  String tituloTarea = '';
  String descripcionTarea = '';
  String fechaFinTarea = '';

  late Alumno? alumnoAsignado = null;
  String DNIalumno = '';
  Enum ventanaOrigen = ventanasOrigen.CREAR_EDITAR;
  String urlImagenPerfilTarea = 'https://media.istockphoto.com/id/1357365823/vector/default-image-icon-vector-missing-picture-page-for-website-design-or-mobile-app-no-photo.jpg?s=612x612&w=0&k=20&c=PM_optEhHBTZkuJQLlCjLz-v3zzxp-1mpNQZsdjrbns=';
  List<CustomCardImage>? pasosTarea = [];

  @override
  State<CrearTareasScreen> createState() => _CrearTareasScreenState();
}

class _CrearTareasScreenState extends State<CrearTareasScreen> {
  int _index = 0;
  ...
  TextEditingController nombreTareaController = TextEditingController(text: '');
  ...
  void initState() {
    ...
    urlImagenPerfilController.text = widget.urlImagenPerfilTarea;
            ...
            children: <Widget>[
              ...
              InkWell(
                  child:
                    ...
                    if (widget.urlImagenPerfilTarea == null)
                      CircleAvatar(
                        radius: 100,
                        backgroundImage:
                        ...
                        Row(
                          children: [
                            ...
                            Container(
                              ...
                              child: ElevatedButton(
                                onPressed: () async {
                                  //AQUI LOS MELONES AÑADEN UN PASO
                                ...
                                onPressed: () {
                                  setState(() {
                                    ...
                                    if (secondFormKey.currentState!
                                        .validate()) {
                                      //Creo id de tarea
                                      String idTarea = 'ta_${DateTime.now()}';
                                      int aux = 0;
                                      ...
                                      _conn.pushPasos(_listOfSteps, idTarea);

                                      if (widget.alumnoAsignado != null) {
                                        _conn.asignarAlumno(
                                            widget.DNIalumno, idTarea);
                                      }
                                    }
